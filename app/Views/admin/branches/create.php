...
<div class="card p-4">
    <form class="needs-validation" novalidate action="<?= base_url('admin/branches/store') ?>" method="POST">
        <?= csrf_field() ?>
        
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="name" class="form-label fw-bold small text-dark">Branch Name</label>
                <input type="text" name="name" id="name" class="form-control <?= (isset($errors['name']) || $validation->hasError('name')) ? 'is-invalid' : '' ?>" value="<?= old('name') ?>" placeholder="e.g. Kovur Center (Main)" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" name="phone" id="phone" class="form-control <?= (isset($errors['phone']) || $validation->hasError('phone')) ? 'is-invalid' : '' ?>" value="<?= old('phone') ?>" placeholder="e.g. +91 94456 62922" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="email" name="email" id="email" class="form-control <?= (isset($errors['email']) || $validation->hasError('email')) ? 'is-invalid' : '' ?>" value="<?= old('email') ?>" placeholder="e.g. clinic@example.com" required>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="url" name="map_url" id="map_url" class="form-control <?= (isset($errors['map_url']) || $validation->hasError('map_url')) ? 'is-invalid' : '' ?>" value="<?= old('map_url') ?>" placeholder="e.g. https://maps.app.goo.gl/..." required>
            ...
            <div class="col-md-12 mb-3">
                ...
                <textarea name="address" id="address" class="form-control <?= (isset($errors['address']) || $validation->hasError('address')) ? 'is-invalid' : '' ?>" rows="3" placeholder="Full address details..." required><?= old('address') ?></textarea>
            ...
            <div class="col-md-12 mb-4">
                ...
                <textarea name="serving_areas" id="serving_areas" class="form-control <?= (isset($errors['serving_areas']) || $validation->hasError('serving_areas')) ? 'is-invalid' : '' ?>" rows="3" placeholder="e.g. Serving clients from Saligramam, Virugambakkam, KK Nagar, Vadapalani..."><?= old('serving_areas') ?></textarea>
