                ...
                <?php if (!empty($branches)): ?>
                    <?php foreach ($branches as $branch): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('admin/branches/edit/' . $branch['id']) ?>" class="btn btn-sm btn-outline-primary btn-action me-1"><i class="fas fa-edit"></i> Edit</a>
                                <a href="<?= base_url('admin/branches/delete/' . $branch['id']) ?>" onclick="return confirm('Are you sure you want to delete this branch location?');" class="btn btn-sm btn-outline-danger btn-action"><i class="fas fa-trash"></i> Delete</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
