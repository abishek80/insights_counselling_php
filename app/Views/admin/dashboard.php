...
<div class="row g-4">
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card p-4 border-start border-4 border-primary h-100">
            ...
            <a href="<?= base_url('admin/team') ?>" class="text-decoration-none small fw-bold mt-3 d-inline-block">Manage Team <i class="fas fa-arrow-right ms-1"></i></a>
        </div>
    </div>

    <!-- Services Indicator -->
    <div class="col-xl-3 col-md-6">
        <div class="card p-4 border-start border-4 border-success h-100">
            <div class="d-flex justify-content-between align-items-center">
                <div>
            ...
            <a href="<?= base_url('admin/services') ?>" class="text-decoration-none text-success small fw-bold mt-3 d-inline-block">Manage Services <i class="fas fa-arrow-right ms-1"></i></a>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
        <div class="card p-4 border-start border-4 border-warning h-100">
            ...
            <a href="<?= base_url('admin/testimonials') ?>" class="text-decoration-none text-warning small fw-bold mt-3 d-inline-block">Manage Reviews <i class="fas fa-arrow-right ms-1"></i></a>
        </div>
    </div>

    <!-- FAQ Indicator -->
    <div class="col-xl-3 col-md-6">
        <div class="card p-4 border-start border-4 border-info h-100">
            <div class="d-flex justify-content-between align-items-center">
                <div>
            ...
            <a href="<?= base_url('admin/faq') ?>" class="text-decoration-none text-info small fw-bold mt-3 d-inline-block">Manage FAQs <i class="fas fa-arrow-right ms-1"></i></a>
        </div>
    </div>
</div>
