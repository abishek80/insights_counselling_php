...
<div class="card p-4">
    <form action="<?= base_url('admin/faq/store') ?>" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="question" id="question" class="form-control" value="<?= old('question') ?>" placeholder="e.g. Do you offer online counseling?" required>
        </div>

        <div class="mb-4">
            <label for="answer" class="form-label fw-bold small text-dark">Answer</label>
            <textarea name="answer" id="answer" class="form-control" rows="5" placeholder="Type the answer here..." required><?= old('answer') ?></textarea>
        </div>
